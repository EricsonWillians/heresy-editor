...
private:
	...
	void ReadControls();
	void WriteControls();
	void CaptureArchitectureControls();
	void WriteArchitectureControls();
	void SyncArchitectureSelectionFromControls();
	void RebuildArchitectureStructureMenu(int family);
	void SaveArchitectureMemory();
	void LoadArchitectureMemory(SectorArchitectureElement element);
	void RefreshTargets();
	void Recompute();
	...
	Fl_Choice *architectureFamily_ = nullptr;
	Fl_Choice *architectureElement_ = nullptr;
	std::vector<SectorArchitectureElement> architectureFamilyElements_;
	Fl_Box *architectureDescription_ = nullptr;
	Fl_Input *architectureBays_ = nullptr;
	Fl_Input *architectureSize_ = nullptr;
	Fl_Input *architectureHeight_ = nullptr;
	Fl_Input *architectureMargin_ = nullptr;
	Fl_Check_Button *architectureMirror_ = nullptr;
	Fl_Choice *architectureFunction_ = nullptr;
