...
#ifdef WIN32
		snprintf(filename, sizeof(filename), "%s/common/about_logo.png", reinterpret_cast<const char *>(global::install_dir.u8string().c_str()));
#else
		snprintf(filename, sizeof(filename), "%s/about_logo.png", reinterpret_cast<const char *>(global::install_dir.u8string().c_str()));
#endif
